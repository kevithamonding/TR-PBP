                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="sn-container">
                            ...
                            <h1 class="sn-title">Bagaimana Cara Mendaftarkan Hak Merek untuk UMKM?</h1>
                                <p>
                                    JAKARTA, PBPNEWS.com - Mendaftarkan Hak Kekayaan Intelektual (HAKI) atau merek menjadi salah satu hal yang penting untuk dilakukan para pelaku UMKM. Merek menjadi penting utamanya bagi pelaku UMKM yang bergerak di bidang kreatif seperti kerajinan dan fashion. Dengan adanya HAKI, pelaku UMKM pun bisa mencegah penyalahgunaan merek dilakukan oleh pihak lain yang tidak bertanggung jawab.
                                </p>
                                <p>
                                    Selain itu pula, dengan memiliki merek dagang, dipercayai bisa mendongkrak pendapatan atau omzet UMKM. Lalu, bagaimana cara mendaftarkannya? Mengutip dari situs resmi umkmindonesia.id, Jumat (4/12/2020), hal pertama yang dilakukan oleh UMKM adalah melakukan pengajuan atau permohonan diri ke instansi terkait. Dalam hal ini, pengajuan bisa diarahkan ke Deputi Bidang Produksi dan Pemasaran, SKDP Provinsi yang membidangi KUMKM ataupun SKDP Kabupaten/Kota yang membidangi KUMKM. Setelah melakukan pengajuan permohonan, segala persyaratan data-data pendaftaran akan diperiksa langsung.
                                </p>
                                <p>
                                    Adapun data yang diperlukan di antaranya adalah formulir pendaftaran, surat pernyataan tentang kepemilikan merek yang telah diketok dan dibubuhi materai, foto kopi NPWP dan KTP, Nama dan Label Merek, Etiket Merek atau contoh merek dalam permohonan merek, dan melampirkan sertifikat register UMKM dari Kementerian Koperasi dan UKM. Apabila persyaratan dinyatakan lengkap, permohonan pun akan diajukan ke Ditjen HKI untuk mendaftarkan hak merek, hingga diproses langsung oleh Ditjen HKI Kemenkum dan HAM. Sementara, apabila persyaratan tidak terpenuhi, pelaku UMKM harus memperbaiki permohonan.
                                </p>
                            </div>
                        </div>
